...
ROOTFS_ISO9660_EFI_PARTITION_SIZE = 3M
...
ROOTFS_ISO9660_GRUB2_EFI_PREFIX = /EFI/BOOT/
ROOTFS_ISO9660_GRUB2_CONFIG_PATH = $(ROOTFS_ISO9660_TMP_TARGET_DIR)/boot/grub/grub.cfg
...
define ROOTFS_ISO9660_INSTALL_GRUB2_EFI
	...
	$(INSTALL) -D -m 0644 /dev/null \
		$(ROOTFS_ISO9660_TMP_TARGET_DIR)$(BR2_TARGET_ROOTFS_ISO9660_GRUB2_EFI_ID_FILE)
	...
	dd if=/dev/zero of=$(ROOTFS_ISO9660_EFI_PARTITION_PATH) bs=$(ROOTFS_ISO9660_EFI_PARTITION_SIZE) count=1
	...
	# Copy efigrub.cfg to EFI partition (backup, though not used)
...
define ROOTFS_ISO9660_INSTALL_GRUB2_CONFIG
	...
	$(SED) "s%__KERNEL_PATH__%/boot/$(LINUX_IMAGE_NAME)%" \
		$(ROOTFS_ISO9660_GRUB2_EFI_CONFIG_PATH)
	$(SED) "s%__EFI_ID_FILE__%$(BR2_TARGET_ROOTFS_ISO9660_GRUB2_EFI_ID_FILE)%" \
		$(ROOTFS_ISO9660_GRUB2_EFI_CONFIG_PATH)
endef
endif
